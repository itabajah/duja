...
two ports that had been held, and **P9 is planned** - the one phase whose scope
was chosen by what the absent hardware still permits ([plan.md](plan.md) has its
four waves). The ports ship as
