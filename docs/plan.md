...
P0 through **P9** are all closed, and their write-ups are in
...
So what is left sorts two ways - what needs a machine this project does not
have, and the part of that which can be *written* here even though it cannot be
...
### 2. Writable here, confirmable only there
...
wave. P6 and P7 were hardware-blind by construction - they were ports to machines
nobody here has - whereas P9 is the first phase whose *scope was chosen* by that
constraint rather than merely limited by it.
