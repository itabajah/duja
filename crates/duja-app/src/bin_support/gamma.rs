...
/// denial of it.
///
/// **What this gap needs is two seams, and only one of them exists.** The first
...
/// answer "not clean", plus a test that reaches `begin_quit`. Narrower than "no
/// `AppState`", much wider than one test.
